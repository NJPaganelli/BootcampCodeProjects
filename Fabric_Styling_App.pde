...
void draw(){
  ...
  if(keyPressed==true)if(key=='S'||key=='s')
    {textFont(BOD_CR);fill(127,127,127);text("Width = 40 Inches",50,250);}
    {textFont(BOD_CR);fill(127,127,127);text("Yarn Type = Silk",50,150);}
    {textFont(BOD_CR);fill(127,127,127);text("Price Per Yard = $8.00",50,350);}
    //size(350,350);
  if(keyPressed==true)if(key=='P'||key=='p')
    {textFont(BOD_CR);fill(127,127,127);text("Width = 120 Inches",50,250);}
    {textFont(BOD_CR);fill(127,127,127);text("Yarn Type = Polyester",50,150);}
    {textFont(BOD_CR);fill(127,127,127);text("Price Per Yard = $3.00",50,350);}
    //size(1000,1000);
   textFont(BOD_CR);fill(127,127,127);text("What Color Yarn Would You Like?",250,150);
